...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header">
        ...
        <a class="navbar-brand" href="ruches.php?">Ruches</i></a>
        <a class="navbar-brand" href="informations.php?">Informations</i></a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $info['date'] ?></td>
                                    <td><?= $info['poids'] ?></td>
                                    <td><?= $info['températures'] ?></td>
                                    <td><?= $info['humidite'] ?></td>
                                    <td>
                                        </a><a href="details.php?id=<?= $info['id'] ?>">Voir</a> <a href="edit.php?id=<?= $info['id'] ?>">Modifier</a> <a href="delete.php?id=<?= $info['id'] ?>">Supprimer</a></td>
                                </tr>
                            <?php
                            }
                            ?>
